...
public class LoopViewPager extends ViewPager {
	...
	public void setAdapter(PagerAdapter adapter, View parentView) {
	...
	public void setAdapter(PagerAdapter adapter) {
		...
		setIndicator(adapter.getCount(), parentView);
	 ...
	 * @param number
	 */
	private void setIndicator(int number, View parentView) {
		indicators = new ImageView[number];
		LinearLayout childView = (LinearLayout) parentView.findViewById(R.id.item_home_viewpager_indicator);
		for (int i = 0; i < number; i++) {
			...
			childView.addView(indicators[i]);
		}
	}
}
