...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		Log.d(VIEW_LOG_TAG, "mScreenWidth=" + mScreenWidth);
		...
		selectedTabTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, tabTextSize, dm);
		...
		// selectedTabTextSize =
		// a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsSelectedTextSize,
		// selectedTabTextSize);
		selectedTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsSelectedTextColor, indicatorColor);
	...
	private void addTab(final int position, View tab) {
		...
		expandedTabLayoutParams.width = mScreenWidth / pager.getAdapter().getCount();
